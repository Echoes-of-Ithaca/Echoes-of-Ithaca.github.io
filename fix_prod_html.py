...
html = re.sub(r'<div class="prod-graphic">.*?</div>\s*</div>\s*</div>', '</div>\s*</div>', html, flags=re.DOTALL)
...
html = html.replace('<h3 data-es="JIRA" data-en="HACK\'N\'PLAN">JIRA</h3>', '<h3 data-es="JIRA" data-en="JIRA">JIRA</h3>')
